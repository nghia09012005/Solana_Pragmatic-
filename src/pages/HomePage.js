...
function HomePage() {
    ...
    const handleSignUp = async () => {
        ...
        if (!success) {
            ...
            alert(
                message ||
                    "Đăng ký thất bại. Tên người dùng đã tồn tại hoặc thông tin bị thiếu."
            );
            switchToSignUp();
            return;
        } else {
    ...
    const CARDS = [
        {
            ...
            description:
                "Da Nang is a breathtaking coastal gem of Vietnam, where golden beaches meet misty mountains and every corner promises a new adventure waiting to be uncovered.",

            artist: {
                name: "Central",

                location: "Viet Nam",
                image: "./images/character/vietnam.webp",
            },
            image: "./images/da-nang.webp",
        },
        {
            title: "Ho Chi Minh City",

            description:
                "A vibrant fusion of tradition and modernity, Ho Chi Minh City pulses with energy—its bustling markets, dynamic street life, and hidden alleyway cafés invite you to discover stories at every corner",
            artist: {
                name: "Southern",
        ...
        },
        {
            ...
            image: "/images/hue.webp",
        },
        {
            title: "Ninh Binh",

            description:
                "With towering limestone cliffs, winding rivers, and ancient pagodas, Ninh Binh feels like a hidden paradise—where nature and history create a landscape straight out of a legend.",
            artist: {
                name: "Northern",
    ...
    const Card = ({ artwork, isActive }) => {
        ...
        const isLocked =
            artwork.title === "Linh Ung Pagoda" ||
            artwork.title === "My Son Sanctuary";

        const handleExpand = () => {
            // Nếu game bị khóa, không làm gì cả
            if (isLocked) {
                alert(
                    "Game này hiện đang được phát triển. Vui lòng quay lại sau!"
                );
                return;
            }
    ...
    return (
        <div className="container">
            ...
            <div className="app" ref={carouselRef}>
                <Carousel>
                    {CARDS.map((artwork, i) => (
                        <Card key={i} artwork={artwork} isActive={i === 0} />
                    ))}
                </Carousel>
            </div>
            ...
            <section className="feature">
                ...
                <div className="feature-grid">
                    <div className="feature-card">
                        <h3> Teleport mode</h3>
                        <p>
                            Teleport Mode allows users to instantly move to
                            popular tourist destinations within the app. This
                            feature helps save time and offers a seamless,
                            immersive way to explore key attractions quickly and
                            easily.
                        </p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <p>
                            Engage with an exciting storyline that unfolds as
                            you progress. Enjoy fun and interactive minigames
                            that challenge your skills and deepen your immersion
                            in the adventure.
                        </p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <p>
                            Discover cultural and historical insights about each
                            destination through guided content and interactive
                            exploration.
                        </p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <p>
                            Enhances transparency and security by using
                            blockchain to verify achievements, track progress,
                            or store unique digital collectibles.
                        </p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <p>
                            Choose from a variety of unique characters, each
                            with their own style, background, and role in the
                            story.
                        </p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <p>
                            Promote travel by showcasing cultural landmarks and
                            unique local attractions through engaging stories
                            and interactive experiences. Inspire users to
                            explore and appreciate real destinations with rich
